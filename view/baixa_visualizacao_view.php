...
$busca  = "SELECT id_baixa_produto, nome, cpf, dt_baixa, usuario FROM tb_baixa_produto AS baixa
            ...
            <form class="form-horizontal" action="../controller/adicionar_produto_baixa.php" method="post">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-2 control-label" for="id_produto">Usuário</label>
                        <div class="col-md-2">
                            <input id="id_produto" name="id_produto" class="form-control input-md" value="<?php echo ($resultado_baixa['usuario']) ?>" disabled type="text" maxlength="5" pattern="[0-9]+$">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            <a href="consultar_baixa_view.php"><button type="button" class="btn btn-primary" value="Salvar">Voltar</button></a>
                        </div>
                        <div class="col-md-3">
                            <a href="../controller/relatorio_baixa_produto.php?id_baixa=<?php echo $id_baixa?>" class="btn btn-primary" name="btn_relatorio">Relatorio de Baixar</a>
                        </div>
                    </div>
            </form>
        </div>
