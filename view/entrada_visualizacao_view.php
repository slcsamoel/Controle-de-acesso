...
$tipo_entrada_produto = $_GET['tpe'];
 ...
 $busca  = "SELECT id_entrada_produto, entrada.id_tp_entrada_produto, dt_entrada, tpen.tipo_entrada_produto, nf_fiscal, usuario FROM tb_entrada_produto AS entrada
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" action="../controller/relatorio_produto_entrada.php" method="post">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-2 control-label" for="id_tp_entrada_produto">Tipo de Entrada </label>
                        <div class="col-md-3">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-2 control-label" for="id_produto">Nome Usuário</label>
                        <div class="col-md-2">
                            <input id="id_produto" name="id_produto" disabled class="form-control input-md" value="<?php echo $row_usuario['usuario']?>" required="" type="text" maxlength="5" pattern="[0-9]+$">
                        </div>

                        <label class="col-md-2 control-label" for="quantidade">Data Entrada</label>
                        <div class="col-md-2">
                            <input id="quantidade" name="quantidade" class="form-control input-md" disabled required="" value="<?php echo date('d/m/Y', strtotime($row_usuario['dt_entrada']))?>" type="text" maxlength="5" pattern="[0-9]+$">
                        </div>
                ...
                while($row_busca = mysqli_fetch_assoc($resultado_busca)){ 
                    ...
                    <div class="form-group">
                        <div class="col-md-8">
                            ...
                            <div class="col-md-1">
                                <a href="consultar_entrada_view.php"><button type="button" class="btn btn-primary" value="Voltar">Voltar</button></a>
                            </div>
                            <div class="col-md-2">
