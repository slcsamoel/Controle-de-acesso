...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" action="../controller/relatorio_pdf_morador.php"  method="post">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-11 control-label">
                                <div class="col-md-2">
                                    <input id="id_morador" name="id_morador" style="display:none;" class="form-control input-md" type="text" maxlength="11" value="<?php echo $id_morador?>" readonly>
                                </div>
                            </div>
