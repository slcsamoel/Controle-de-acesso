        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <label required="" class="radio-inline" for="radios-0">
                  <input name="sexo" id="sexo" <?php if($morador['sexo'] == 'feminino'){ echo "checked"; } ?> value="feminino" type="radio" <?= $desativar ?> >
                  Feminino
                </label>
                <label class="radio-inline" for="radios-1">
                  <input name="sexo" id="sexo" <?php if($morador['sexo'] == 'masculino'){ echo "checked"; } ?> value="masculino"  type="radio" <?= $desativar ?> >
                  Masculino
                </label>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-2">
                <input id="rg" name="rg"  class="form-control input-md"  type="text" value="<?php echo $morador['rg']?> " maxlength="11" pattern="[0-9]+$" <?= $desativar ?> >
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <input id="dt_cadastro" name="dt_cadastro"  class="form-control input-md"  type="datetime" value="<?php echo $morador['dt_cadastro']?>" maxlength="13" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()" <?= $desativar ?> >
            </div>
            ...
            <div class="col-md-2">
              <input id="placa" name="placa" placeholder="letra e numeros" class="form-control input-md"  value="<?php echo $morador['placa']?>" <?= $desativar ?> >
            </div>
            <label class="col-md-2 control-label" for="descricao_veiculo">Descrição do Veiculo<h11></h11></label>
            <div class="col-md-2">
              <input id="descricao_veiculo" name="descricao_veiculo"  class="form-control input-md"  value="<?php echo $morador['descricao_veiculo']?>" <?= $desativar ?> >
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
            <select required id="tipo_morador" name="tipo_morador" class="form-control" <?= $desativar ?> >
            ...
            <div class="col-md-2">
            <input id="dt_cadastro" name="dt_cadastro" placeholder="DD/MM/AAAA"  class="form-control input-md"  type="datetime" value="<?php if($movimentacao['id_tp_movimentacao']< 2)echo $movimentacao['dt_movimentacao'];?>" maxlength="13" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()" disabled >
            </div>
            <label class="col-md-1 control-label" for="dt_cadastro">Saida</label>
            <div class="col-md-2">
            <input id="dt_cadastro" name="dt_cadastro" placeholder="DD/MM/AAAA"  class="form-control input-md"  type="datetime" value="<?php if($movimentacao['id_tp_movimentacao']>1)echo $movimentacao['dt_movimentacao']; ?>" maxlength="13" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()" disabled >
            </div>
            <div class="col-sm-2">
          ...
          <div class="form-group">
            ...
            <div class="col-md-1">
              <button type="submit" class="btn btn-primary"  name="salvar" <?='style="display:'.$display.'"'?>>Salvar</button>
            </div>
          </div>
