      ...
      <form class="form-horizontal" action="../controller/cadastra_visitante.php" method="post" >
        ...
        <div class="panel panel-primary">
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <input id="dt_nascimento" name="dt_nascimento" placeholder="DD/MM/AAAA" class="form-control input-md" required="" type="date" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <div class="input-group">
                ...
                <input id="id_morador" name="id_morador" class="form-control" placeholder="" required="" type="text">
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <select required id="id_tipo_visita" name="id_tipo_visita" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              ...
              <div class="col-md-3">
                <button type="submit" class="btn btn-primary" value="entrada" >entrada</button>
              </div>
            </div>
